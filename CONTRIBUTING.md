# Contributing to Serverless Devs Core
...
- [Contributing to Serverless Devs Core](#contributing-to-serverless-devs)
  - [Topics](#topics)
...
To be honest, we regard every user of Serverless Devs Core as a very kind contributor. After experiencing Serverless Devs Core, you may have some feedback for the project. Then feel free to open an issue via [NEW ISSUE](https://github.com/Serverless-Devs/Serverless-Devs/issues/new/choose).
...
Right now we assume every contribution via pull request is for [branch develop](https://github.com/Serverless-Devs/Serverless-Devs/tree/develop) in Serverless Devs Core. Before contributing, be aware of branch definition would help a lot.
...
* docs: xxxx. For example, "docs: add docs about Serverless Devs Core cluster installation".
...
In addition, in the code change part, we suggest that all contributors should read the [code style of Serverless Devs Core](#code-style).
...
PR is the only way to make change to Serverless Devs Core project files. To help reviewers better get your purpose, PR description could not be too detailed. We encourage contributors to follow the [PR template](./.github/PULL_REQUEST_TEMPLATE.md) to finish the pull request.
...
For the development of Serverless Devs Core Package, please refer to the [development guide](https://github.com/Serverless-Devs/Serverless-Devs/discussions/62). After the development is completed, please refer [PR](https://github.com/Serverless-Devs/package-awesome) to the summary warehouse for more reference.
...
* discuss about Serverless Devs Core to make things clearer;
* advocate Serverless Devs Core technology beyond GitHub;
* write blogs on Serverless Devs Core and so on.
